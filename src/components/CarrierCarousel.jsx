...
const CARRIERS = [
    { name: 'IndiGo', type: 'FLIGHT', code: '6E', color: '#1a56db', textColor: '#fff', emoji: '✈️' },
    { name: 'Air India', type: 'FLIGHT', code: 'AI', color: '#c41e3a', textColor: '#fff', emoji: '✈️' },
    { name: 'SpiceJet', type: 'FLIGHT', code: 'SG', color: '#f97316', textColor: '#fff', emoji: '✈️' },
    { name: 'Vistara', type: 'FLIGHT', code: 'UK', color: '#6d28d9', textColor: '#fff', emoji: '✈️' },
    { name: 'Indian Railways', type: 'TRAIN', code: 'IR', color: '#065f46', textColor: '#fff', emoji: '🚂' },
    { name: 'KSRTC', type: 'BUS', code: 'KS', color: '#b45309', textColor: '#fff', emoji: '🚌' },
    { name: 'MSRTC', type: 'BUS', code: 'MS', color: '#1e40af', textColor: '#fff', emoji: '🚌' },
